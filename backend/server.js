...
const dbPath = process.env.NODE_ENV === 'production'
    ? path.join(__dirname, 'warehouse.db')  // Render: бекенд працює в backend/
    : path.join(__dirname, '..', 'warehouse.db');  // локально
...
app.get('/api/health', (req, res) => {
    res.json({ status: 'OK', service: 'scrap-metal-api', timestamp: new Date().toISOString() });
});
