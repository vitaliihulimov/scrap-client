    ...
    try {
        ...
        if (metalCount < 64) {
            ...
            const metals = [
                ...
                [34, "Височка скрап", 70],
                [35, "Нержавіюча стружка (10%)", 60],  // Розділено на три позиції
                [36, "Нержавіюча стружка (9%)", 60],
                [37, "Нержавіюча стружка (8%)", 60],
                [38, "Нержавіючий скрап", 65],
                [39, "Нікель", 350],
                [40, "Нікель лом", 320],
                ...
                // Свинець та АКБ
                [44, "Свинець кабельний", 55],
                [45, "Свинець звичайний", 45],
                [46, "Свинець шиномонтаж", 45],
                [47, "АКБ білий", 20],
                [48, "АКБ чорний", 18],
                [49, "ТНЖ великі", 25],
                [50, "ТНЖ маленькі", 25],
